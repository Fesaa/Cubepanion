...
public class EggWarsMapInfoManager {
  ...
  private void registerEggWarsMaps() {
    ...
    this.eggWarsMapLayouts.put("aquatic", new CrossEggWarsMap("Aquatic", 4, 89, AquaticGenLayout, "light_purple", "dark_blue", "yellow", "red"));
    ...
    this.eggWarsMapLayouts.put("mangrove", new CrossEggWarsMap("Mangrove", 4, 45, MangroveGenLayout, "dark_blue", "yellow", "dark_purple", "red"));
    ...
    this.eggWarsMapLayouts.put("magic", new SquareEggWarsMap("Magic", 4, 106, MagicGenLayout, Arrays.asList("red", "green"), Arrays.asList("dark_aqua", "yellow")));
  }
